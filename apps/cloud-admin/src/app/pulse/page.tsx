...
function Footer() {
  return (
    <footer style={{ background: BRAND.bg, borderTop: `1px solid ${BRAND.line}`, padding: "48px 20px" }}>
      <div style={{ maxWidth: 1140, margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", gap: 18 }}>
        ...
        <div style={{ display: "flex", gap: 20, fontSize: 13, color: BRAND.muted, flexWrap: "wrap", justifyContent: "center" }}>
  ...
  useEffect(() => {
    ...
    style.textContent = `
      ...
      @media(max-width:720px){
        ...
        .p-grid-three,.p-grid-four{grid-template-columns:1fr !important}
        .p-title{font-size:36px !important;line-height:1.08 !important;letter-spacing:-1.5px !important}
        .pulse-section{padding:28px 0 !important}
        .p-hero-btns{flex-direction:column !important;align-items:stretch !important}
        .p-hero-btns a{width:100% !important;text-align:center !important}
        header .pulse-container,footer .pulse-container{width:calc(100% - 32px)}
        .p-nav-links{display:none !important}
        .p-stats-grid{grid-template-columns:1fr 1fr !important;gap:12px !important}
        .p-demo-tabs button{padding:8px 2px !important;font-size:9px !important}
        .p-tagline{font-size:20px !important}
        .p-subhead{font-size:16px !important}
      }
      @media(max-width:380px){
        .p-title{font-size:30px !important}
